...
<!-- Auxiliares -->
<script src="recursos/js/lrf/lrf.js"></script>
...
<script>
	...
	function estruturaPagina() {
		...
		$('#formulario')
				.load(
						'recursos/includes/formulario/lrf/formulario_lrf_despesa_detalhada.jsp');
		$('#menu_lateral').load('recursos/includes/menu/menu_lateral_lrf.jsp');
...
<body>
	...
	<div class="container text-center">
		<div class="col-lg-12">
			<div class="alert alert-info">LEI DE RESPONSABILIDADE FISCAL</div>
		</div>
	</div>
	<div class="container text-center">
		<div class="col-lg-12">
