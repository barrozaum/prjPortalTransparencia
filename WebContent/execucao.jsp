...
<!-- Auxiliares -->
<script src="recursos/js/execucao/execucao.js"></script>
...
<script>
	...
	function estruturaPagina() {
		$('#formulario')
				.load(
						'recursos/includes/formulario/execucao/despesa/formulario_despesa_sub_funcao.jsp');
		$('#menu_lateral').load(
				'recursos/includes/menu/menu_lateral_execucao.jsp');
...
<body>
	...
	<div class="container text-center">
		<div class="col-lg-12">
			<div class="alert alert-info">EXECUÇÃO</div>
		</div>
	</div>
	<div class="container text-center">
		<div class="col-lg-12">
